...
runTest(int argc, char** argv)
{
    ...
    cutilDrvSafeCallNoSync(cuParamSeti( matrixMul, 0,  d_C ));
    cutilDrvSafeCallNoSync(cuParamSeti( matrixMul, 4,  d_A ));
    cutilDrvSafeCallNoSync(cuParamSeti( matrixMul, 8,  d_B ));
    cutilDrvSafeCallNoSync(cuParamSeti( matrixMul, 12, WA ));
    cutilDrvSafeCallNoSync(cuParamSeti( matrixMul, 16, WB ));
    cutilDrvSafeCallNoSync(cuParamSetSize( matrixMul, 20 ));
